...
CREATE TABLE `patient_medicine` (
  ...
  KEY `FKPatient_Me738844` (`Medicine_id`),
  KEY `FKPatient_Me36309` (`Patient_id`),
  CONSTRAINT `FKPatient_Me36309` FOREIGN KEY (`Patient_id`) REFERENCES `patient` (`Patient_id`),
  CONSTRAINT `FKPatient_Me738844` FOREIGN KEY (`Medicine_id`) REFERENCES `medicine` (`Medicine_id`)
